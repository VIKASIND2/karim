...
checking_ig_status = 'Checkinig instagram status...'
user_logged_in_text = 'You are already logged in!'
input_security_code_text = 'Send below the security code generated by your Authenticator App or that was sent to you via SMS by Instagram:'
